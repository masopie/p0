...
# Add "end" to class Drawer

# Line 27 added an argument to add_item method

# Line 61-63 added clean_silverware method

# Line 36, in dump method, made @contents = empty array

# Line 99-100, create new spoon Silverware instance, then adding it to our Silverware_drawer (instance of Drawer)

# Add attr_reader method to Silverware class